...
sorted_on_state = sorted(project_listing, key=operator.itemgetter(6))
...
#             row_range = 'A' + str(rc) + ':G' + str(rc)
#             format_cell_range(sheet, row_range, fmt)
#         elif row['state'] == 'live':
#             if (int(row['subjects_count']) - int(row['retired_subjects_count']))\
#                     / int(row['14 day avg. activity']) >= 1095:
#                 fmt = CellFormat(backgroundColor=Color(1, .7, 0))
#                 row_range = 'A' + str(rc) + ':G' + str(rc)
#                 format_cell_range(sheet, row_range, fmt)
#             elif (int(row['subjects_count']) - int(row['retired_subjects_count']))\
#                     / int(row['14 day avg. activity']) >= 547:
